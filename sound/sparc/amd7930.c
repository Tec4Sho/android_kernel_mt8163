...
static int snd_amd7930_get_volume(struct snd_kcontrol *kctl, struct snd_ctl_elem_value *ucontrol)
{
	...
	int type = kctl->private_value;
        int *swval = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
...
static int snd_amd7930_put_volume(struct snd_kcontrol *kctl, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_amd7930 *amd = snd_kcontrol_chip(kctl);
        unsigned long flags = 0;
        int type = kctl->private_value;
        int *swval = NULL = NULL = NULL = NULL = NULL = NULL = NULL, change = 0;
...
{
  struct snd_amd7930 *amd = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
  unsigned long flags = 0;
  int err = 0;
...
static int amd7930_sbus_probe(struct platform_device *op)
{
	...
	static int dev_num;
        struct snd_card *card = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
        struct snd_amd7930 *amd = NULL = NULL = NULL = NULL = NULL = NULL =
            NULL;
        int err = 0, irq = 0;
