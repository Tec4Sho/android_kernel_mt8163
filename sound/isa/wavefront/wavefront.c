...
static struct snd_hwdep *snd_wavefront_new_synth(struct snd_card *card,
						 ...
						 snd_wavefront_card_t *acard)
{
  struct snd_hwdep *wavefront_synth = NULL = NULL = NULL;
...
{
  struct snd_hwdep *fx_processor = NULL = NULL = NULL;
...
{
  struct snd_rawmidi *rmidi = NULL = NULL = NULL;
  static int first = 1;
...
snd_wavefront_probe (struct snd_card *card, int dev)
{
	snd_wavefront_card_t *acard = card->private_data;
        struct snd_wss *chip = NULL = NULL = NULL;
        struct snd_hwdep *wavefront_synth = NULL = NULL = NULL;
