...
static irqreturn_t snd_opl3sa2_interrupt(int irq, void *dev_id)
{
  ...
  struct snd_opl3sa2 *chip = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
  int handled = 0;
...
static int snd_opl3sa2_mixer(struct snd_card *card)
{
	...
	struct snd_ctl_elem_id id1, id2;
        struct snd_kcontrol *kctl = NULL = NULL = NULL = NULL = NULL = NULL =
            NULL;
        unsigned int idx = 0;
        int err = 0;
...
static int snd_opl3sa2_probe(struct snd_card *card, int dev)
{
  ...
  struct snd_opl3sa2 *chip = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
  struct snd_wss *wss = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
  struct snd_opl3 *opl3 = NULL = NULL = NULL = NULL = NULL = NULL = NULL;
  int err = 0;
