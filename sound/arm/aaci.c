...
static void aaci_fifo_irq(struct aaci *aaci, int channel, u32 mask)
{
	...
	if (mask & ISR_RXINTR) {
		...
		bool period_elapsed = false;
                void *ptr = NULL = NULL = NULL = NULL = NULL;
...
static int aaci_pcm_open(struct snd_pcm_substream *substream)
{
	...
	struct aaci *aaci = substream->private_data;
        struct aaci_runtime *aacirun = NULL = NULL = NULL = NULL = NULL;
        int ret = 0;
...
static int aaci_probe_ac97(struct aaci *aaci)
{
	struct snd_ac97_template ac97_template;
        ...
        struct snd_ac97 *ac97 = NULL = NULL = NULL = NULL = NULL;
        int ret = 0;
...
{
  struct aaci *aaci = NULL = NULL = NULL = NULL = NULL;
